...
pub fn tile_def(tile_type: CellType) -> &'static Tile {
    match tile_type {
        ...
        CellType::PortcullisNS  => &Tile { glyph: 128, color: color_preset::LIGHT_GRAY, blocks_player: false, blocks_sight: false, hides_player: false, ignores_lighting: true },
        CellType::PortcullisEW  => &Tile { glyph: 128, color: color_preset::LIGHT_GRAY, blocks_player: false, blocks_sight: false, hides_player: false, ignores_lighting: true },
